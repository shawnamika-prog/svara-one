...
const libraryLink=document.querySelector('aside a[href="#library"]');libraryLink?.addEventListener('click',()=>{window.SvaraLibrary?.refresh?.();setTimeout(()=>window.SvaraLibrary?.refresh?.(),1500)},true);
