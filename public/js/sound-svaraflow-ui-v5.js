(()=>{
  ...
  function brand(){
    ...
    style.textContent=`
      ...
      #soundWorkspace .sound-sf-textarea-wrap.thinking{position:relative!important;background:#050a14!important;box-shadow:0 0 22px #8b5cff18,0 0 42px #ff8a3d10!important;overflow:visible!important}
      #soundWorkspace .sound-sf-textarea-wrap.thinking::before{content:"";position:absolute!important;inset:0!important;padding:2px!important;border-radius:inherit!important;pointer-events:none!important;z-index:0!important;background:conic-gradient(from 0deg,#ffffff10 0deg 300deg,#5d70ff 309deg,#8b5cff 320deg,#bd5cff 332deg,#ff8a3d 344deg,#ffb36e 352deg,#ffffff10 360deg)!important;-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0)!important;-webkit-mask-composite:xor!important;mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0)!important;mask-composite:exclude!important;animation:soundSfPerimeterSpinV7 1.9s linear infinite!important}
      ...
      @keyframes soundSfPerimeterSpinV7{to{transform:rotate(360deg)}}
    `;
