(()=>{
  ...
  soundStyle.textContent=`
    ...
    .sound-history-item{display:grid;grid-template-columns:minmax(300px,1.7fr) 75px 75px 90px 100px 130px;gap:12px;align-items:center;padding:13px 14px;border:1px solid #ffffff0b;border-radius:11px;background:#09111e}.sound-history-item>.sound-history-play{grid-column:1;grid-row:1}.sound-history-item>.sound-history-main{grid-column:1;grid-row:1;padding-left:42px}
