(()=>{
  ...
  soundStyle.textContent=`
    ...
    .sound-history-item{display:grid;grid-template-columns:minmax(300px,1.7fr) 75px 75px 90px 100px 130px;gap:12px;align-items:center;padding:13px 14px;border:1px solid #ffffff0b;border-radius:11px;background:#09111e}.sound-history-item>.sound-history-play{grid-column:1;grid-row:1;position:relative;z-index:2}.sound-history-item>.sound-history-download{grid-column:1;grid-row:1;position:relative;z-index:2;margin-left:38px;width:30px;height:30px;padding:0;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px}.sound-history-item>.sound-history-main{grid-column:1;grid-row:1;padding-left:114px;pointer-events:none}
    .sound-history-item:hover{border-color:#a85cff24;background:#0b1523}
    .sound-history-move{grid-column:1;grid-row:1;position:relative;z-index:2;margin-left:76px;border:1px solid #ffffff10;border-radius:50%;background:#0b1523;color:#cdb0ff;padding:0;width:30px;height:30px;font:700 11px Inter;cursor:pointer;display:flex;align-items:center;justify-content:center}.sound-history-move:hover{background:#151f30;color:#fff;border-color:#a85cff44}
  ...
  const bindSoundHistoryMoves=()=>{soundHistoryList?.querySelectorAll("[data-sound-history-move]").forEach(button=>button.addEventListener("click",()=>openSoundMoveModal(button.dataset.soundHistoryMove).catch(error=>console.error("Sound move dialog failed",error))));};
