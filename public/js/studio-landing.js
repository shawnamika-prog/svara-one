(()=>{
  ...
  soundStyle.textContent=`
    ...
    .sound-history-item{display:grid;grid-template-columns:minmax(300px,1.7fr) 75px 75px 90px 100px 130px;gap:12px;align-items:center;padding:13px 14px;border:1px solid #ffffff0b;border-radius:11px;background:#09111e}.sound-history-item>.sound-history-play{grid-column:1;grid-row:1;position:relative;z-index:2}.sound-history-item>.sound-history-main{grid-column:1;grid-row:1;padding-left:42px;pointer-events:none}
    .sound-history-item:hover{border-color:#a85cff24;background:#0b1523}
    .sound-history-download{border:1px solid #ffffff10;border-radius:8px;background:#0b1523;color:#aebdcb;padding:7px 9px;font:700 10px Inter;cursor:pointer}.sound-history-download:hover:not(:disabled){background:#151f30;color:#fff;border-color:#a85cff44}.sound-history-download:disabled{opacity:.28;cursor:default}
