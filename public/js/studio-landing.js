(()=>{
  ...
  soundStyle.textContent=`
    ...
    .sound-history-table-head{display:grid;grid-template-columns:minmax(300px,1.7fr) 65px 65px 90px 105px 115px 130px 106px;gap:12px;padding:10px 34px;color:#62768b;font-size:8px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;border-bottom:1px solid #ffffff0b}.sound-history-item{display:grid;grid-template-columns:minmax(300px,1.7fr) 65px 65px 90px 105px 115px 130px 106px;gap:12px;align-items:center;padding:13px 14px;border:1px solid #ffffff0b;border-radius:11px;background:#09111e}.sound-history-actions{display:flex;align-items:center;gap:7px}.sound-history-actions .sound-history-play,.sound-history-actions .sound-history-download,.sound-history-actions .sound-history-move{margin:0;position:static;z-index:auto}.sound-history-main{min-width:0}
