(()=>{
  ...
  function styles(){
    ...
    style.textContent=`
      #soundWorkspace .sound-source-select{display:none!important}
      ...
      .sound-voice-picker-sidebar{border-right:1px solid #ffffff0b;padding:17px 12px;background:#07101b;min-height:0;overflow:auto;scrollbar-width:thin;scrollbar-color:#8c5bb7 #07101b}.sound-voice-picker-sidebar::-webkit-scrollbar{width:9px}.sound-voice-picker-sidebar::-webkit-scrollbar-track{background:#07101b}.sound-voice-picker-sidebar::-webkit-scrollbar-thumb{background:linear-gradient(180deg,#8c5bb7,#4b619d);border-radius:999px;border:2px solid #07101b;background-clip:padding-box}
      .sound-voice-picker-sidebar-head{padding:3px 8px 12px}.sound-voice-picker-sidebar-head strong{display:block;font-size:11px;letter-spacing:.1em}.sound-voice-picker-sidebar-head small{display:block;margin-top:4px;color:#63768d;font-size:8px;line-height:1.5}
      ...
      .sound-voice-picker-main{display:flex;flex-direction:column;min-width:0;min-height:0;overflow:hidden}.sound-voice-picker-head{padding:17px 18px 14px;border-bottom:1px solid #ffffff0b;flex:0 0 auto}.sound-voice-picker-title{display:flex;align-items:flex-start;justify-content:space-between;gap:15px}.sound-voice-picker-title strong{font-size:15px;letter-spacing:-.02em}.sound-voice-picker-close{width:30px;height:30px;border:1px solid #ffffff10;border-radius:9px;background:#0a1523;color:#91a3b6;font-size:16px;cursor:pointer}.sound-voice-picker-close:hover{border-color:#a85cff66;color:#e0c1ff}
      ...
      .sound-voice-picker-list{flex:1;min-height:0;overflow:auto;padding:14px 16px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-content:start;gap:9px;scrollbar-width:thin;scrollbar-color:#8c5bb7 #07101b}.sound-voice-picker-list::-webkit-scrollbar{width:9px}.sound-voice-picker-list::-webkit-scrollbar-track{background:#07101b}.sound-voice-picker-list::-webkit-scrollbar-thumb{background:linear-gradient(180deg,#8c5bb7,#4b619d);border-radius:999px;border:2px solid #07101b;background-clip:padding-box}.sound-voice-picker-list::-webkit-scrollbar-thumb:hover{background:linear-gradient(180deg,#a56bd0,#5d73b2);border-color:#07101b}
  ...
  const tryBind=()=>{if(root()?.querySelector('.sound-source'))bind();else setTimeout(tryBind,50)};
  tryBind();
})();